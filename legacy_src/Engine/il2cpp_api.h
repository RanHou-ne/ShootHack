// This header is an X-macro list and is intentionally included multiple times.
// IntelliSense may parse this file standalone, where DO_API is undefined.
// Provide a fallback declaration form for editor diagnostics only.
